...
===================================================== */
  ...
  return (
    <motion.article
      ...
      className="
        group relative grid overflow-hidden rounded-2xl border border-gray-700/70
        bg-gray-900/95 shadow-[0_12px_40px_rgba(0,0,0,0.25)]
        transition-all duration-500 hover:-translate-y-1
        hover:border-[#f3f009]/30 hover:shadow-[0_18px_50px_rgba(0,0,0,0.35)]
        md:grid-cols-2
      "
    >
      {/* IMAGE */}
      <div
        className={`
          group/image relative min-h-[220px] cursor-pointer overflow-hidden
          md:min-h-[270px] ${index % 2 !== 0 ? 'md:order-2' : ''}
        `}
      ...
      >
        ...
        <div
          className="
            ...
            from-gray-950/70 via-gray-950/5 to-transparent
          "
        />
        ...
        <span
          className="
            ...
            border border-white/10 bg-gray-950/75 px-3 py-1.5 text-[10px]
            font-bold uppercase tracking-[0.15em] text-[#f3f009]
        ...
        <div
          className="
            ...
            border border-white/20 bg-gray-950/75 px-3 py-2 text-xs
            font-semibold text-white opacity-90 shadow-lg backdrop-blur-md
            transition-all duration-300 group-hover:border-[#f3f009]
            group-hover:bg-[#f3f009] group-hover:text-gray-950
          "
        >
      ...
      <div
        className={`
          flex flex-col justify-between p-5 sm:p-6 md:p-7
