...
const HeroSocials: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center md:mt-0 mt-3 space-x-6 md:justify-start">
      {/* LinkedIn */}
        ...
        >
          <a
            ...
            className="
              ...
              rounded-full border-2 border-[#f3f009] bg-[#f3f009] text-black
              shadow-[0_0_12px_rgba(243,240,9,0.25)]
              transition-all duration-300
              hover:bg-black hover:text-[#f3f009]
              hover:shadow-[0_0_20px_rgba(243,240,9,0.4)]
              focus:outline-none focus:ring-2 focus:ring-[#f3f009]
            "
          >
    ...
    whitespace-nowrap rounded-md bg-black px-3 py-1
    text-xs font-medium text-white transition-opacity duration-300
    md:text-sm
    ${
